    ...
    *****************/
    $.fn.priceFormat = function(options)
    {
        ...
        return this.each(function()
        {
            ...
            $(this).bind('focus', price_on_focous);

            
            // return original value On Focus.
            function price_on_focous(){
                val = val_inpt(obj.val())
                obj.val(val);
                // console.log(val);
            }

            // Function to generate orginal value.
            function val_inpt(inp){
                field = inp
                result = "";
