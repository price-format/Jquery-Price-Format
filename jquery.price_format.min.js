...
s&&(d(this).bind("focusout",function(){r()}),d(this).bind("focusin",function(){var a=e.val();e.val(a+i)}));0<d(this).val().length&&(f(),p(),r())})};jQuery.fn.unmask=function(){var a=d(this).val(),g="",f;for(var f = 0; f < a.length; f++)if(!isNaN(a[f])||"-"==a[f])g+=a[f];return g}})(jQuery);
